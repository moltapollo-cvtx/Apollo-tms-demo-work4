...
async function main() {
  ...
  for (let i = 1; i <= 15; i++) {
    ...
    tractors_data.push({
      ...
      plateState: "TX",
      registrationExpiration: new Date(2026, 11, 31),
      inspectionExpiration: new Date(2026, 5, 30),
  ...
  for (let i = 0; i < 20; i++) {
    ...
    drivers_data.push({
      ...
      cdlState: "TX",
      cdlExpiration: new Date(2026 + Math.floor(Math.random() * 3), Math.floor(Math.random() * 12), Math.floor(Math.random() * 28) + 1),
      medicalCertExpiration: new Date(2025, 6 + Math.floor(Math.random() * 6), Math.floor(Math.random() * 28) + 1),
  ...
  for (const driver of createdDrivers) {
    ...
    for (const qualType of driverQualifications) {
      qualifications_data.push({
        ...
        issuedBy: "Texas DPS",
        issueDate: new Date(2022 + Math.floor(Math.random() * 2), Math.floor(Math.random() * 12), Math.floor(Math.random() * 28) + 1),
        expirationDate: new Date(2026 + Math.floor(Math.random() * 3), Math.floor(Math.random() * 12), Math.floor(Math.random() * 28) + 1),
  ...
  for (const driver of createdDrivers) {
    ...
    for (const certType of driverCertifications) {
      certifications_data.push({
        ...
        issueDate: new Date(2022 + Math.floor(Math.random() * 2), Math.floor(Math.random() * 12), Math.floor(Math.random() * 28) + 1),
        expirationDate: new Date(2025 + Math.floor(Math.random() * 3), Math.floor(Math.random() * 12), Math.floor(Math.random() * 28) + 1),
  ...
  for (let i = 0; i < Math.min(assignableOrders.length, 15); i++) {
    ...
    assignments_data.push({
      ...
      dispatchedAt: order.status !== "assigned" ? new Date() : null,
    });
  }
